...
<DIV style='width: 80%; margin: 0px auto;'>
  <FORM name='frm' method='POST' action='./login.do'>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input" name='id' id='id' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='password' class="form-control input" name='passwd' id='passwd' value='${ck_passwd }' required="required" style='width: 30%;' placeholder="패스워드">
        <Label>
